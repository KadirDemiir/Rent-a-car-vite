                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {FEATURES.map((feature, index) => (
                            <div key={index} className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 group text-center md:text-left">
                                <div className="text-4xl mb-4 bg-white w-16 h-16 rounded-full flex items-center justify-center shadow-sm mx-auto md:mx-0 group-hover:scale-110 transition-transform">
                                    {feature.icon}
                                </div>
            ...
            <div className="py-16 bg-white relative z-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-end mb-10">
                        ...
                        <a href="#" className="hidden md:flex items-center gap-1 text-red-600 font-semibold hover:text-red-700 transition-colors">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {renderedLocations.map((loc, index) => (
                            <div key={loc.id || index} className="group relative h-64 rounded-2xl overflow-hidden cursor-pointer shadow-md">
                                <img
                                ...
                                <div className="absolute bottom-4 left-4 text-white">
                                    ...
                                    <span className="text-sm text-gray-300 pl-6 group-hover:text-white transition-colors flex items-center gap-1">
                                        Detayları Gör <ArrowRight size={14} className="opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all" />
                                    </span>
                                </div>
                            </div>
                        ))}
                ...
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                        ...
                        <div className="relative">
                            <div className="w-24 h-24 bg-gray-800 rounded-full flex items-center justify-center text-3xl mx-auto border-4 border-gray-900 mb-6 shadow-lg z-10">
                                📅
                            </div>
                        ...
                        <div className="relative">
                            <div className="w-24 h-24 bg-red-600 rounded-full flex items-center justify-center text-3xl mx-auto border-4 border-gray-900 mb-6 shadow-lg z-10">
                                🔑
                            </div>
