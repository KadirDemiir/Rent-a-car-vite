            ...
            <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-blue-50">
                ...
                <div className="flex items-center justify-center px-4 py-12">
                    <div className="w-full max-w-md">
                        ...
                        {localMessage && (
                            <div className="bg-white border-x border-gray-100 px-8 pt-6">
                                {localMessage.type === 'error' && (
                                    <div
                                        className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-start gap-2 mb-4">
                                        <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor"
                                             viewBox="0 0 20 20">
                                ...
                                {localMessage.type === 'success' && (
                                    <div
                                        className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-start gap-2 mb-4">
                                        <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="currentColor"
                                             viewBox="0 0 20 20">
                                            <path fillRule="evenodd"
                        ...
                        {/* Form Content */}
                        {formType === 'Login' ? <LogInForm onMessage={handleMessage} setFormType={setFormType}/> :
                            <SignUpForm onMessage={handleMessage} setFormType={setFormType}/>}
                    </div>
                </div>
            </div>
        </>
