        ...
        <div className={`w-full`}>
            <Navbar >
                ...
                <div className={`w-full flex items-center justify-between`}>
                    <div><Link href={`/${i18n.language}/${t("address.adminpanel")}/${t("address.languages")}`}><span className={`font-medium text-gray-600 hover:text-gray-700`}>Show All</span></Link> / <span className={`text-gray-700`}>{language.name}</span></div>
