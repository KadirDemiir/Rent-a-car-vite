                    ...
                    return(
                        <div 
                            ...
                            className={`relative group rounded-xl p-4 transition-all duration-200 cursor-pointer ${
                                isSelected 
                                    ? 'bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-600 shadow-md' 
                            ...
                            <div className="flex justify-between items-start gap-3">
                                ...
                                <div className="flex flex-col items-end gap-2 flex-shrink-0">
                                    <div className={`h-7 w-7 ring-2 rounded-full flex items-center justify-center transition-all ${
                                        isSelected ? 'ring-blue-600 bg-blue-600' : 'ring-gray-300 bg-white'
                                    }`}>
                                        {isSelected && (
                                    ...
                                    {isSelected && e.type === 'daily' && (
                                        <div className="flex items-center gap-1 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg px-2 py-1 shadow-md" onClick={(e) => e.stopPropagation()}>
                                            <button 
                                                className="w-6 h-6 flex items-center justify-center rounded-md bg-white text-blue-600 hover:bg-gray-100 transition-colors font-bold text-sm"
