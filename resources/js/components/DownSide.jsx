...
export default function DownSide() {
    return (
        <nav className="bg-blue-500 h-[10vh] flex items-center justify-center">
        <ul className="flex items-center justify-center gap-4 h-full w-[80%]">
            <li className="h-full hover:bg-blue-600 flex flex-1 items-center justify-center rounded-md">
                <Link href="/cars" className="h-full w-full text-white flex items-center justify-center">Cars</Link>
            </li>
            <li className="h-full hover:bg-blue-600 flex-1 flex items-center justify-center rounded-md">
