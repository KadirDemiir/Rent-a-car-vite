    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // Marka ve Model isimlerini çekme mantığı
                // NOT: Eğer Backend'den "translations" tablosu joinli gelmiyorsa t() fonksiyonu sadece key döndürür.
                // Burada backend'den gelen çevirileri işlemeye çalışıyoruz.
